...
def default():
    ...
    yspec_desc = "105 power, CAN ONLY USE ONCE"
    ospec_desc = "105 power, CAN ONLY USE ONCE"
...
def rerun():
    ...
    def P2():
        ...
        if yhp2 > 0:    
                ...
                if ohp2 >= (+int(ohp * .38)):
                    ...
                    if cpuact == 6:
                        ...
                        if ospec_cnt == 1:
                            ...
                            ospecc = ospecc + 1
                            if crit > 1:
                                yhp2 = +int(yhp2 - ((((oat2 * 8.4) / (ydf2 * 8.4)) * sa)*(ol2 / 5)))
                                print ("[Special] " +str(User1)+ ", your Hp is now -> [" +str(yhp2)+ "]")
                                a = 4
                                print ("")
                                print ("")
                            if crit == 1:
                                yhp2 = +int(yhp2 - (((((oat2 * 8.4) / (ydf2 * 8.4)) * sa)*(ol2 / 5))*1.875))
            ...
            if User2 != "Cpu":
                for stufffffffff in range(1000):
                    oact = input("What will be your action " +str(User2)+ "?")
                    print ("")
                    print ("")
                    ...
                    if oact == "Virus" :
                        for something in range(10000000000000000000000000000000000000000):
    ...
    def P():
        ...
        if yhp2 > 0:
            for something in range(100):
                yact = input("What will your action be " +str(User1)+ "?")
                print ("")
                print ("")
                ...
                if yact == "Special" or yact == "6":
                    ...
                    if yspec_cnt == 1:
                        ...
                        yspecc = yspecc + 1
                        if crit > 1:
                            ohp2 = +int(ohp2 - ((((yat2 * 8.4) / (odf2 * 8.4)) * sa)*(yl2 / 5)))
                            ohp2 = ohp2
                            ...
                            break
                        if crit == 1:
                            ohp2 = +int(ohp2 - (((((yat2 * 8.4) / (odf2 * 8.4)) * sa)*(yl2 / 5))*1.875))
                            ohp2 = ohp2
    ...
    def message():
        ...
        print ("" +str(User2)+ " Attack -> [" +str(oat2)+ "]")                       #Message that shows after every turn#
    ...
    def inputs():
        ...
        global crit
        default()
        User1 = input("Who will be player 1?")
        User1 == User1
        print ("")
        print ("")
        User2 = input("Who will be player 2?(Cpu if you want to play against a computer)")
        User2 == User2
        print ("")
        print ("")
